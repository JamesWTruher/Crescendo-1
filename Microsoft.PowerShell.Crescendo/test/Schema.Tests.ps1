Describe "Schema tests" {
    BeforeAll {
        ...
        # v1 schema will not pass these tests.
        # Additional tests may be needed when a new schema is released.
    ...
    Context 'Each element should have a description' {
        BeforeAll {
            # find the properties in the classes of the object model and
            # every property should be found in the schema.
            $xPath = @()
